      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        ...
        >
          ...
          <p className="text-gray-400 mb-8">
            Join a platform where conversations feel alive and connections are
            real.
          </p>

          <button className="px-8 py-4 rounded-full bg-blue-600 hover:bg-blue-700 font-semibold shadow-lg shadow-blue-600/30 transition">
            Get Started
          </button>
        </motion.div>
